...
<body>
    ...
    @if ($user->exist == 1 || session("manager"))
        <div class="container">
            <div class="contents pt-5 mt-5 w-75 mx-auto text-center">
                ...
                <div class="row my-4">
                    ...
                    <div class="col d-flex align-items-center justify-content-end">
                        ...
                        @elseif ($follow_flg == "myself" or $follow_flg == "guest")
                        {{-- ユーザーがアクセスしたユーザー自身または未ログインの時は何も表示しない --}}
        ...
        <div class="container">
            <div class="contents pt-5 mt-5 w-75 mx-auto text-center">
                ...
                <div class="row my-4">
                    <div class="col-1 p-0 d-flex align-items-center">
                        <!-- アイコン -->
                        <img src="{{ asset('image/default.png') }}" alt="" class="w-100 img-fluid">
                    </div>
                    {{-- <p>id:{{ $user->id }}</p> --}}
                    <!-- ユーザ名 -->
                    <div class="col d-flex align-items-center fs-3">退会済みユーザー</div>
                </div>

                <div class="row my-4">
                    <!-- フォロー -->
                    <span class="col d-block text-dark text-decoration-none">
                        <p class="d-inline mr-2">フォロー</p>
                        <p class="d-inline m-2" name="follow_count" id="follow_count">0</p>
                    </span>
                    <!-- フォロワー -->
                    <span class="col text-dark text-decoration-none">
                        <p class="d-inline mr-2">フォロワー</p>
                        <p class="d-inline m-2" name="follower_count" id="follower_count">0</p>
                    </span>
                </div>
                ...
                <div class="my-4">
                    <div class="row">
                        <div class="col">
                            <span class="text-decoration-none link-dark">購入者評価</span>
                        </div>
                        <p class="col">評価なし</p>
                    </div>
                    <div class="row">
                        <div class="col">
                            <span class="text-decoration-none link-dark">販売者評価</span>
                        </div>
                        <p class="col">評価なし</p>
                    </div>
                </div>
