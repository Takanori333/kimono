                ...
                <form action="/fleamarket/exhibit/confirm" method="POST" enctype="multipart/form-data" id="item_create_form">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-sm-8">
                            <div >
                                <div class="w-100">
                                    <label for="input_img" class="border-1 border py-2 mt-1 w-100 rounded-0">画像を選択</label>
                                </div>
                                ...
                                <div id="show_img_area" class="position-relative w-25">
                                    @isset( $images )
                                    @foreach ($images as $key => $image )
                                    <img src="{{ $image }}" class="w-100 mb-1" id="show_image_{{$key}}">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-sm-2 col-form-label">値段</div>
                        <p class="col-sm text-danger py-2 m-0 text-end">必須</p>
                        <div class="col-sm-8">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select name="pref" class="form-control rounded-0 form-select">
        ...
        const addImage = function(){
            ...
            for( let i=0,l=fileList.length; l>i; i++ ) {
                ...
                fileReader.onload = function() {
                    ...
                    show_img.innerHTML += '<img src="' + dataUri + '" class="w-100 mb-' + (i+1) +'" id="show_image_' + img_id + '" >';
                    show_img.innerHTML += '<div class="position-absolute top-0 end-0 w-25 h-25"><button type="button" class="btn btn-danger" id="btn_image_' + img_id + '" onclick="del_img(' + img_id + ')">×</button></div>';
