        ...
        <div class="row">
               ...
               <div class="dropdown ">
                  <a class="btn btn-secondary dropdown-toggle w-100" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu vh-100 min-vh-100 fixed-top w-100 overflow-auto" aria-labelledby="dropdownMenuLink">
                            ...
                            <li>
                                <a class="dropdown-item customer_item" href="javascript:void(0);" onclick="change_customer_message('{{ asset('/chat/stylist_user_get_message')}}','{{  csrf_token()  }}','{{ $customer->id }}')">{{ $customer->name }}{{ $customer->readed }}</a>
                            </li>                                
                            @endforeach
                        </ul>
                </div>
            ...
            <div class="col-12 col-lg-8 col-md-8 col-sm-8 col-xl-8 col-xxl-8  vh-100 min-vh-100 " style="padding-top: 40px">
                <div class="" style="width: 100%;height: 100%">
                    ...
                    <div class="row border-warning border-bottom" style="height: 65%;margin:0;display:block;overflow-y:auto;overflow-x:hidden" id="message_box"></div>
                    <div class="row border-warning border-bottom" style="height: 5%;max-height: 100px;margin: 0;display: flex;justify-content: flex-end;">
                        <button style="width: 20%;max-width: 80px;height: 80%;max-height: 40px;position: relative;padding: 0;margin: 0;align-self: center;font-size: 15px;margin-right:20px" onclick="open_reverse()">予約を作る</button>
                        <button style="width: 20%;max-width: 80px;height: 80%;max-height: 40px;position: relative;padding: 0;margin: 0;align-self: center;font-size: 15px;margin-right:20px" onclick="sendMsg()">send</button>
                    </div>
