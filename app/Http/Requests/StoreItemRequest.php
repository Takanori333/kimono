...
class StoreItemRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'size_heigh' => 'required|numeric|regex:/((^[0-9]{1})(.[0-9]{0,2}$))/',
    ...
    public function messages(){
        return [
            ...
            'size_heigh.required' => ':attributeが記入されていません',
            'size_heigh.numeric' => ':attributeは数字で入力してください',
            'size_heigh.regex' => '0.00m から 9.99m の範囲で入力してください',
